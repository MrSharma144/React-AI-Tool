  ...
  const askQuestion = async () => {
    ...
    try {
      ...
      if (!response.candidates || !response.candidates[0]) {
        toast.error("Gemini API did not return a valid response");
        setLoading(false);
        return;
      }
  ...
  return (
    <div className={darkMode === "dark" ? "dark" : "light"}>
      ...
      <div className="grid grid-cols-6 h-screen text-center">
        <select
          className="fixed top-3 right-3 bg-amber-50 dark:bg-zinc-800 dark:text-white text-zinc-600 p-2 rounded-md"
        ...
        <div className="col-span-5 bg-amber-50 dark:bg-zinc-900 p-10 h-screen flex flex-col">
          <h1 className="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-pink-700 to-violet-700 pb-2">
